 ...
 * @author gcmartins
 */
public class JFXMenuButtonSkin extends MenuButtonSkin {
    ...
    public JFXMenuButtonSkin(JFXMenuButton button) {
        super(button);
    ...
    protected void layoutChildren(final double x, final double y, final double w, final double h) {
        if (invalid) {
            if (((JFXMenuButton) getSkinnable()).getRipplerFill() == null) {
                ...
                buttonRippler.setRipplerFill(((JFXMenuButton) getSkinnable()).getRipplerFill());
            }
            invalid = false;
        }
        double shift = 1;
